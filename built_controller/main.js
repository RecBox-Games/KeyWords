...
import { get_role_screen, size_role_screen } from "./game/role_screen/init.js";
...
const loops = [loading_loop, loading_loop, role_screen_loop, main_loop, end_loop];
const app = () => {
    handle_message();
    loops[state]();
    drawablesRenderAll();
...
export const set_role_screen_state = (role_state) => {
