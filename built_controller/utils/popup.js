...
let popup;
export const get_popup = () => { return popup; };
// opening and closing popup //
export function try_post_popup(header, message) {
    if (get_menu().is_tut_enabled) {
        post_popup(header, message);
    }
}
export function post_popup(header, message) {
    fill_popup();
    size_popup();
...
export const exit_popup_clicked = (_self) => {
