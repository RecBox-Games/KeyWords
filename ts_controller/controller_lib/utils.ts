...
export const center_text = (text:string, font:string, dest:Rectangle) => {
...
export const scale_and_center = (src:Rectangle, dst:Rectangle, scale:number) =>
{
    src.w *= scale;
    src.h *= scale;
...
//TODO : Find a way to disable right click role_screen on long presses
