...
export const DEFAULT_DRAWABLE_TEXT:DrawableText = {coords:{x: 0, y: 0}, boundingBox:{x: 0, y: 0, w : 0, h : 0}, center:true, fill: false, font: '24px arial', color : '#000000', text: "no_text"};
